...
DialPresenter.prototype.subscribeSources = function () {
    var self = this;
    var subscribedSources = [];
    function subscribe(source) {
        var bindingSource = presentationBindingSource(source);
...
DialPresenter.prototype.setValue = function (ringIndex, normalizedValue, transactionId) {
...
DialPresenter.prototype.resetValue = function (ringIndex, transactionId) {
    var configuration = (this.options.rings || [])[ringIndex];
