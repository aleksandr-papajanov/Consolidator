...
{
    const normalized = clampPresentationValue(value, 0, 1);
...
module.exports = {
    clampPresentationValue: clampPresentationValue,
    normalizePresentationValue: normalizePresentationValue,
    denormalizePresentationValue: denormalizePresentationValue
};
