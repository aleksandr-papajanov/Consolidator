...
class BiquadLowShelfFilter final : public BiquadFilter {
public:
    explicit BiquadLowShelfFilter(LowShelfFilterSettings settings)
    ...
    void UpdateSettings(const LowShelfFilterSettings& settings) {
...
private:
    static Coefficients CreateCoefficients(const LowShelfFilterSettings& settings) {
