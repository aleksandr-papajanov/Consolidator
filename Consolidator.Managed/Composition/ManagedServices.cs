using Consolidator.Managed.Analysis;
...
using Consolidator.Managed.Composition.ServiceExtensions;
using Consolidator.Managed.State;
using Consolidator.Managed.State.History;
using Microsoft.Extensions.DependencyInjection;

namespace Consolidator.Managed.Composition;
...
public static class ManagedServices
{
    ...
    internal static ServiceProvider CreateProvider()
    {
        ...
        services.AddSingleton<IInstancePresentationLifecycle>(serviceProvider =>
            serviceProvider.GetRequiredService<PresentationOutputGate>());
        ...
        services.AddSingleton<IRegistryChangeSink>(serviceProvider =>
            serviceProvider.GetRequiredService<RegistryChangePublisher>());
        services.AddSingleton<IHistoryStateSink>(serviceProvider =>
            serviceProvider.GetRequiredService<HistoryStatePublisher>());
        services.AddSingleton<IProcessorMarkerSink>(serviceProvider =>
            serviceProvider.GetRequiredService<ProcessorMarkerPublisher>());
        services.AddSingleton<IPersistenceChangeSink>(serviceProvider =>
        ...
        services.AddSingleton(serviceProvider =>
            new InstanceRegistry(
                ...
                serviceProvider.GetRequiredService<IRegistryChangeSink>(),
                serviceProvider.GetRequiredService<IAnalyzerLifecycle>()));
        services.AddSingleton(serviceProvider =>
            new InstancePersistenceService(
                serviceProvider.GetRequiredService<InstanceRegistry>(),
                serviceProvider.GetRequiredService<IOperationGate>(),
                serviceProvider.GetRequiredService<IPersistenceChangeSink>(),
                serviceProvider.GetRequiredService<DspStateChangeTracker>()));
        ...
        services.AddSingleton<ICommandHandler, SetBankBypassCommandHandler>();
        ...
        services.AddSingleton<IInputCodec, SetBankBypassInputCodec>();
        ...
        services.AddCommandEndpoint<SetProcessorBypassCommand, StateWriteStatus>(
            ...
            "action_done");
        services.AddCommandEndpoint<SetBankBypassCommand, StateWriteStatus>(
            "set_bank_bypass",
            "action_done");
        ...
        services.AddSingleton<IAnalyzerLifecycle>(serviceProvider =>
