{
  "patcher": {
    ...
    "boxes": [
      ...
      { "box": { "id": "processor", "maxclass": "newobj", "text": "consolidator.dspprocessor", "numinlets": 3, "numoutlets": 5, "outlettype": ["signal", "signal", "", "", ""], "patching_rect": [30.0, 105.0, 180.0, 22.0] } },
    ...
    "lines": [
      ...
      { "patchline": { "source": ["processor", 4], "destination": ["telemetrySend", 0] } },
